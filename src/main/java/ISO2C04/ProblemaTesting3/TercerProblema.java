package ISO2C04.ProblemaTesting3;
...
public class TercerProblema {
	...
	private static int validarTemperatura(Scanner scanner) {
	    while (true) {
	        try {
	...
	private static boolean validarBoolean(Scanner scanner) {
        while (true) {
            try {
    ...
    private static int validarIntPositivo(Scanner scanner) {
        while (true) {
            try {
    ...
    private static int validarHumedadRelativa(Scanner scanner) {
        while (true) {
            try {
                int value = scanner.nextInt();
                if (value < 0) {
    ...
    private static int rangoTemperatura(int temperatura) {
        if (temperatura < 0) {
